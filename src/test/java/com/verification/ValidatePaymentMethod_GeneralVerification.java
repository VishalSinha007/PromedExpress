...
public class ValidatePaymentMethod_GeneralVerification extends AbstractPage{

	public ValidatePaymentMethod_GeneralVerification(WebDriver driver) {
		super(driver);
 ...
 */
	...
	public boolean Order_Confirmation() throws UnsupportedEncodingException, URISyntaxException, IOException {
		...
		WebDriverWait confirmationmessage=new WebDriverWait(driver, 100);
		confirmationmessage.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//h1[@class='page-title']//span")));
		
		WebElement confirmation_message = driver.findElement(By.xpath("//h1[@class='page-title']//span"));
...
//=================================================================================================================================================================
	...
	public boolean CreateNewAccountRegistrationMessage() throws UnsupportedEncodingException, URISyntaxException, IOException{
		...
		if(confirmationmessage.isDisplayed()){
			Common.logstep("Confirmation Message is Displayed===>"+confirmationmessage.getText()+"</br>");
			System.err.println("Confirmation Message is Displayed===>"+confirmationmessage.getText());
			logStatus("Pass");
	...
	public boolean My_Cart_Verification1() throws UnsupportedEncodingException, URISyntaxException, IOException {
	...
	public boolean Verify_Item_Quantity1() throws UnsupportedEncodingException, URISyntaxException, IOException {
 ...
 */
	...
	public boolean Order_Confirmation1() throws UnsupportedEncodingException, URISyntaxException, IOException {
	...
	public boolean Address_Validation1(){
