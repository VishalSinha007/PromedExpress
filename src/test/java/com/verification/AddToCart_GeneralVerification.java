...
public class AddToCart_GeneralVerification extends AbstractPage {

	public AddToCart_GeneralVerification(WebDriver driver) {
		super(driver);
	}
 ...
 */
	...
	public boolean Order_Confirmation() throws UnsupportedEncodingException, URISyntaxException, IOException {
		...
		WebDriverWait confirmationmessage=new WebDriverWait(driver, 30);
